...
const { values, handleSubmit, defineField, errors } =
    useForm({
                ...
                <div class="modal-lead__form-top">
                    <div class="modal-lead__form-group">
                        <div class="input-group">
                            ...
                            <input v-model="name" v-bind="nameAttrs" class="input-group__input" type="text"
                        ...
                        <div class="input-group">
                            ...
                            <input v-model="phone" v-bind="phoneAttrs" class="input-group__input" type="text"
                                v-phone-mask placeholder="+998 90 123 45 67" />
